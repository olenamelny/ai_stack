...
- Copy the **direct** connection string (no `-pooler` suffix)

### 2. GitHub environment + secret

1. Go to **Settings → Environments → New environment**
2. Name it exactly `prod`
3. Add a secret inside that environment:
   - Name: `DATABASE_URL`
...
1. Create a branch: `git checkout -b feat/your-migration-name`
...
4. GitHub Actions runs the migration automatically
...
├── migrations/
│   ├── README.md              # Conventions and schema plan
